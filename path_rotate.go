	...
	return []*framework.Path{
		{
			...
			Callbacks: map[logical.Operation]framework.OperationFunc{
				...
				logical.CreateOperation: b.pathRotateCredentialsUpdate(),
			},
		...
		},
		{
			...
			Callbacks: map[logical.Operation]framework.OperationFunc{
				...
				logical.CreateOperation: b.pathRotateRoleCredentialsUpdate(),
			},
...
func (b *backend) pathRotateCredentialsUpdate() framework.OperationFunc {
...
func (b *backend) pathRotateRoleCredentialsUpdate() framework.OperationFunc {
	return func(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
